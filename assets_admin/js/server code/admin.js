...
/*function validate_add_product(ele) {
	...
	var fk_lang = jQuery('#fk_lang_id').val();
    ...
    if(jQuery.trim(product_code)=='') { showError("Please Select Language", "fk_lang_id"); hasError = 1; } else { changeError("fk_lang_id"); }
	...
	if(jQuery.trim(fk_lang)=='') { showError("Select Language", "fk_lang_id"); hasError = 1; } else { changeError("fk_lang_id"); }
