                ...
                <div class="header-top-left col-lg-12 col-md-8 col-sm-6 col-xs-4">
                    <ul class="top-link list-inline hidden-lg hidden-md">
                        <li class="account" id="my_a  ccount">
                            <a href="#" title="My Account " class="btn-xs dropdown-toggle" data-toggle="dropdown"> <span
                                    class="hidden-xs">My Account </span> <span class="fa fa-caret-down"></span>
                            </a>
                            <ul class="dropdown-menu ">
                                <li><a href="Frontend/registration"><i class="fa fa-user"></i> Register</a></li>
                                <li><a href="<?php echo base_url();?>Frontend/login"><i
                        ...
                        <li class="language">
                            <div class="btn-group languages-block ">
                              ...
                              foreach ($lang_name as $lang_name_key => $lang_name_row) { ?>
                                    <option value="<?= $lang_name_row['id']?>"
                                        <?php $session_data=$this->session->userdata('logged_in'); if($session_data['lang_id'] == $lang_name_row['id']){ ?>
                                        selected=selected <?php } ?>><?= $lang_name_row['lang_name']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <div class="logo"><a href="<?php echo base_url(); ?>Frontend"><img
                                src="<?php echo base_url();?>assets_frontend/image/logo.png" title="Your Store"
                                alt="Your Store" style="margin-top: -40px !important;" /></a></div>
                </div>
                <!-- //end Logo -->
                <!-- Main menu -->
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <a href="index-2.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="<?php echo base_url();?>assets_frontend/image/catalog/menu/home-1.jpg"
                                                                                alt="">
                                                                        </span>
                                                                        <h3 class="figcaption">Home page - (Default)
                                                                        </h3>
                                                                    </a>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <a href="home2.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="<?php echo base_url();?>assets_frontend/image/catalog/menu/home-2.jpg"
                                                                                alt="">
                                                                        </span>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="home3.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="<?php echo base_url();?>assets_frontend/image/catalog/menu/home-3.jpg"
                                                                                alt="">
                                                                        </span>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="home4.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="<?php echo base_url();?>assets_frontend/image/catalog/menu/home-4.jpg"
                                                                                alt="">
                                                                        </span>
                                       ...
                                       <b class="caret"></b>
                                                ...
                                                <li class="with-sub-menu hover" style="left:-100px !important">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        ...
                                                        <img class="label-hot"
                                                            src="<?php echo base_url();?>assets_frontend/image/catalog/menu/hot-icon.png"
                                                            alt="icon items">
                                                        <b class="caret"></b>
                                                    </a>
                                                    <div class="sub-menu"
                                                        style="width: 100%; display: none;left:-150px !important">
                                                        <div class="content">
                                                            <div class="row">
                                                                <?php  foreach($cat_data as $cat_data_key => $cat_data_row){?>
                                                                <div class="col-md-3">
                                                                    <a href="<?php echo base_url().'Frontend/category?catid='.base64_encode($cat_data_row['category_id']); ?>"
                                                                        class="title-submenu"><?php echo $cat_data_row['category_name'] ?></a>
                                                                    <div class="row">
                ...
                <div class="middle-right col-lg-4 col-md-3 col-sm-6 col-xs-8">
                    <div class="signin-w  hidden-sm hidden-xs">
                     ...
                     if(empty($user_session_data)){ ?>
                            ...
                            <?php }else{ ?>
                            <span><strong><?=$user_session_data['user_name']?></strong></span> | <a
                                href="<?php echo base_url();?>Frontend/logout"
                                style="font-size: 15px; color: #fd7e14; width: 20% !important;"><span><strong>Logout</strong></span></a>
                            <?php }
                     ?>
                                            ...
                                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <defs>
                                                    <clipPath id="user_svg__clip0">
                                                        <path fill="#fff" transform="translate(1.2 2.4)"
                                                            d="M0 0h21.6v21.6H0z"></path>
                                                    </clipPath>
                                                </defs>
                                            </svg>
                                        </div>
                                ...
                                <div class="shopcart">
                                    ...
                                    <div class="shopcart-inner refesh1">
                                        <span class="total-shopping-cart cart-total-full">
                                            <span
                                                class="items_cart"><?php if($cart_count > 0){ echo $cart_count; }else{ echo '0';} ?></span>
                                        </span>
                                    </div>
                                </div>
                            </a>
                                       ...
                                       foreach($cart_data as $key => $value){ ?>
                                                <tr>
                                                    ...
                                                    <td class="text-left"> <a class="cart_product_name"
                                                            href="product.html"><?php echo $value['product_name'] ?></a>
                                                    </td>
                                                    <td class="text-center"><?php echo $value['cart_qty'] ?></td>
                                                    <td class="text-center"><?php echo $value['product_offer_price'] ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <a href="product.html" class="fa fa-edit"></a>
                                                    </td>
                                                    <td class="text-right">
                                                        <a id="<?=$value['cart_id'];?>" type="button"
                                                            class="fa fa-times fa-delete romove_cart_details"></a>
                                                    </td>
                                                </tr>
                                                <?php }
                                       } ?>
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <p class="text-right"> <a class="btn view-cart"
                                                    href="<?php echo base_url();?>Frontend/cart"><i
