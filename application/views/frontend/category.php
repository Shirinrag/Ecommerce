                                ...
                                <div class="product-item-container">
                                    <div class="left-block">
                                        <div class="product-image-container second_img">
                                            <a href="product.html" target="_self"
                                                title="<?php echo $value['product_name'];?>">
                                                <img src="<?php echo $value['image_name'];?>"
                                                    class="img-1 img-responsive"
                                                    alt="<?php echo $value['imagename'];?> ?>">
                                            </a>
                                        </div>
                                    ...
                                    <div class="right-block">
                                        <div class="caption">
                                            ...
                                            <h4><a href="" class="textellipse"
                                                    title="<?php echo $value['product_name'];?>"
                                                    target="_self"><?php echo $value['product_name'];?></a></h4>
                                            <div class="price"> <span
                                                    class="price-new"><?php echo $value['currency_in_english'];?>
                                                    <?php echo $value['product_offer_price'];?></span>
                                                <span class="price-old"><?php echo $value['currency_in_english'];?>
                                                    <?php echo $value['product_purchase_price'];?></span>
                                            </div>
