...
<!-- Mirrored from demo.smartaddons.com/templates/html/emarket/home2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 06:24:53 GMT -->
                            ...
                            <div class="btn-group languages-block ">
                                <form action="https://demo.smartaddons.com/templates/html/emarket/index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a href="index-2.html"> <img class="image_flag" src="image/catalog/flags/ar.png" alt="Arabic" title="Arabic" /> Arabic </a> </li>
                                    </ul>
                                </form>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-lg-2 col-md-3 col-sm-12 col-xs-12">
                    <div class="logo"><a href="index-2.html"><img src="image/catalog/logo2.png" title="Your Store" alt="Your Store" /></a></div>
                </div>
                <!-- //end Logo -->
                <!-- Search -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-9 col-xs-12 hidden-xs">
                        <ul class="footer-links">
                            ...
                            <li><a href="index3d18.html?route=affiliate/login">Affiliates</a>
                            </li>
                            <li><a href="index1766.html?route=information/information&amp;information_id=6">FAQ's</a>
                            </li>
                            <li><a href="index71ba.html?route=account/return/add">Returns</a>
                            </li>
                            <li><a href="#">Privacy</a>
                            </li>
                            <li><a href="index2724.html?route=information/contact">Contact</a>
                            </li>
                        </ul>
                    </div>
...
<!-- Mirrored from demo.smartaddons.com/templates/html/emarket/home2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Jun 2022 06:25:07 GMT -->
</html>