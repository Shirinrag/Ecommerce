                                        ...
                                        <div class="product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="<?=base_url();?>Frontend/product_details?id=<?php echo base64_encode($product_row['product_id']) ?>"
                                                        target="_self" title="Pastrami bacon">
                                                        <img src="<?php echo $product_row['image_name']?>"
                                                            class="img-1 img-responsive"
                                                            alt="<?php echo $product_row['image_name']?>">
                                                        <img src="<?php echo $product_row['image_name']?>"
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    ...
                                                    <strong><a class="textellipse"
                                                            href="<?=base_url();?>Frontend/product_details?id=<?php echo base64_encode($product_row['product_id']) ?>"
                                                            title="Pastrami bacon"
                                                            target="_self"><?php echo $product_row['product_name']; ?></a></strong>
                                                    <div class="price">QAR
                                                        <?php echo $product_row['product_offer_price']; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="item">
                                    <div class="item-inner product-layout transition product-grid">
                                        ...
                                        <div class="product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="<?=base_url();?>Frontend/product_details?id=<?php echo base64_encode($best_selling_row['product_id']) ?>"
                                                        target="_self" title="Pastrami bacon">
                                                        <img src="<?php echo $best_selling_row['image_name']?>"
                                                            class="img-1 img-responsive"
                                                            alt="<?php echo $best_selling_row['image_name']?>">
                                                        <img src="<?php echo $best_selling_row['image_name']?>"
                                                            class="img-2 img-responsive"
                                                            alt="<?php echo $best_selling_row['image_name']?>">
                                                    </a>
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    ...
                                                    <strong><a class="textellipse"
                                                            href="<?=base_url();?>Frontend/product_details?id=<?php echo base64_encode($best_selling_row['product_id']) ?>"
                                                            title="Pastrami bacon"
                                                            target="_self"><?php echo $best_selling_row['product_name']; ?></a></strong>
                                                    <div class="price">QAR
                                                        <?php echo $best_selling_row['product_offer_price']; ?></div>
                                                </div>
                                            </div>
                                        </div>
