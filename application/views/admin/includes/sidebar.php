<style type="text/css">
    ...
    line-height: 10px;
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="<?php echo base_url();?>Admin"><img src="<?php echo base_url();?>uploads/<?php echo $company[0]['company_logo']; ?>" style="width: 150px;height: 80px;object-fit: contain;"></a>
                ...
                <li><a href="<?php echo base_url();?>Admin/product_list">Product List</a></li> </ul>
                <li class="xn-openable">
