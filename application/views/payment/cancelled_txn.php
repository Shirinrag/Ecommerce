    ...
    <div class="container">
        <div class="checkout-box">
            <div class="row">
                ...
                <div class="col-md-12">
                <h2 class="heading-title"> <img src="<?php echo base_url().'assets/images/cancel.png';?>"> ORDER CANCELLED</h2>
                    <div class="panel-group checkout-steps" id="accordion">
                        <div class="panel panel-default checkout-step-01">
                            <div class="panel-body">
                                <div class="error">                               
                                    Oops.. You have CANCELLED your transaction. <a href="<?php echo base_url();?>account/view_my_cart">Click here to Re-Initiate the transaction </a>
                                </div>
                            </div>
                        </div>
                    </div>
