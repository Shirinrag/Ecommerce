...
<body onload="submitPayuForm()" style="margin: 0px;">
	...
	<form action="<?php echo $action; ?>" method="post" name="payuForm" style="display:none">
		...
		<table>
			...
			<tr>
				<td>Product Info: </td>
				<td colspan="3"><textarea name="productinfo">DIRECT FARM ADD MONEY TO Wallet</textarea></td>
				<!-- <?php echo (empty($posted['productinfo'])) ? '' : $posted['productinfo'] ?> -->
			</tr>
			<tr>
				<td>Success URI: </td>
				<td colspan="3"><input name="surl" value="<?php echo base_url();?>profile/success_txn" size="64" /></td>
			</tr>
			<tr>
				<td>Failure URI: </td>
				<td colspan="3"><input name="furl" value="<?php echo base_url();?>profile/profile_cancelled_txn" size="64" /></td>
			</tr>
			...
			<tr>
				<td>UDF1: </td>
				<td><input name="pg" value="<?php echo (empty($txn_code)) ? '' : $txn_code; ?>" /></td>
				<td>UDF2: </td>
