...
article.archive-style1 {
    margin-bottom: 30px;
    border-bottom: 1px solid #d2d2d2;
    padding: 0 0 30px;
}
#comments, .blog-main article, .blog-sidebar-widget {
    border: 0px solid #e8e6e6;
    padding: 0 0 10px;
    font-size: 14px;
    margin-bottom: 10px;
}
.archive-style1.post .post-thumb {
    margin: 0;
}
.post .post-thumb {
    margin: 0px;
...
#comments .comments-title, #respond #reply-title, .blog-main .entry-title, .blog-sidebar-widget .widgettitle {
    background-color: #f4f4f4;
    padding: 14px;
    font-weight: bold;
}
.archive-style1 .article-footer {
    border-top-width: 0;
    padding: 10px 0 0 0;
    margin: 0;
}
...
.blog-main article .meta .author, .home-blogs .blog-first .meta .author {
    color: #012169;
    font-weight: 600;
}
.icon.icon-user {
...
.blog-main article .meta .comments, .home-blogs .blog-first .meta .comments {
...
.icon.icon-clock {
    ...
    background-position: -150px -54px !important;
}
.icon.icon-comment {
    width: 24px;
    height: 26px;
...
.blog-main article .meta .icon-share, .home-blogs .blog-first .meta .icon-share {
...
<!-- <link rel="stylesheet" href="<?php //echo base_url()?>assets/css/jquery-ui-1.12.0.css"/> -->
      ...
      <div class="container" style="margin-top: 14em;">
          <div class="row">
              <div class="col-md-12">
                  <div class="row">
                      <img src="<?php echo base_url();?>/uploads/blogs/<?php echo $blog_data['image_name'];?>" style="width:100%;height: 360px;">
                      <div class="col-md-8">
                          <div class="box-heading">
                              <h2><?php echo ucfirst($blog_data['title']);?></h2>
                          </div>
                          <p><?php echo $blog_data['description'];?></p><br>
                            <?php if(!empty($blog_details)){ ?>


                              <h3>Our Authorised Importers</h3>
                              <p>The following are the detailed list of Brand Authorised Importers from which we procure our products.</p>
                                <?php foreach ($blog_details as $bdkey => $bdvalue) { ?>
                                  <h3><?php echo strtoupper($bdvalue['title']);?></h3>
                                  <img src="<?php echo base_url();?>uploads/blogs/<?php echo $bdvalue['image_name'];?>" style="width:250px;"><br>
                                  <p>KAR Enterprises are the official importer of brands like Ultimate Nutrition and BioX Nutrition in India.</p>
                                  <ul>
                                      <li><span>Ultimate Nutrition - </span>Ultimate Nutrition was founded in 1979 by Victor H. Rubino. Ultimate Nutrition was among the first companies to have Amino Acid tablets, protein powders, carbohydrate powders, and various types of Fat Burners.</li>
                                      <li><span>BioX Nutrition - </span>BioX Nutrition offers the widest assortment of athletic supplements in the business ranging from Protein Powders, Ready to Drink Protein and Energy Drinks, High Protein Nutrition Bars, Weight Gain and Weight loss aids as well as athletic performance enhancing supplements.</li>
                                  </ul>
                                <?php } ?>

                            <?php } ?>
                          <!-- <h3>KAR Enterprises</h3>
                          <img src="<?php //echo base_url();?>assets/images/a2.png" style="width:250px;">
                          <p>KAR Enterprises are the official importer of brands like Ultimate Nutrition and BioX Nutrition in India.</p>
                          <ul>
                              <li><span>Ultimate Nutrition - </span>Ultimate Nutrition was founded in 1979 by Victor H. Rubino. Ultimate Nutrition was among the first companies to have Amino Acid tablets, protein powders, carbohydrate powders, and various types of Fat Burners.</li>
                              <li><span>BioX Nutrition - </span>BioX Nutrition offers the widest assortment of athletic supplements in the business ranging from Protein Powders, Ready to Drink Protein and Energy Drinks, High Protein Nutrition Bars, Weight Gain and Weight loss aids as well as athletic performance enhancing supplements.</li>
