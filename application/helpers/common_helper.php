...
function sendSMS($mobile_no,$message){
   //echo '<pre>'; print_r('hii'); exit;
    ...
    $url = "http://bulk.mdsms.in:7412/api/mt/SendSMS?user=marcos&password=marcos@123&senderid=MARCOS&channel=trans&DCS=0&flashsms=0&number=".$mobile_no."&text=".$message."&route=1038";
